...
let slideIndex=1
button.addEventListener("click", () => { section.classList.add("up"); });
button2.addEventListener("click", () => { breakfast.classList.add("up"); });
button3.addEventListener("click", () => { way.classList.add("up"); });
button4.addEventListener("click", () => { on_way.classList.add("up"); });
school_btn.addEventListener("click", () => { school.classList.add("up"); });
changeSlide(1)
